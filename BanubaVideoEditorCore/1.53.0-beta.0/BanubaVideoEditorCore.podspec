Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaVideoEditorCore/1.53.0-beta.0/BanubaVideoEditorCore-1.53.0-beta.0.xcframework.zip", :type => "zip" }
