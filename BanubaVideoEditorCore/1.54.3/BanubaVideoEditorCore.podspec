Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaVideoEditorCore/1.54.3/BanubaVideoEditorCore-1.54.3.xcframework.zip", :type => "zip" }
