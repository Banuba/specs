Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaGenAIVideos/1.54.0/BanubaGenAIVideos-1.54.0.xcframework.zip", :type => "zip" }
