Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaPhotoEditorSDK/1.4.0-beta.0/BanubaPhotoEditorSDK-1.4.0-beta.0.xcframework.zip", :type => "zip" }
