Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaUtilities/1.53.0-beta.2/BanubaUtilities-1.53.0-beta.2.xcframework.zip", :type => "zip" }
