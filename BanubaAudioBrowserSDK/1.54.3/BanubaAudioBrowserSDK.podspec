Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaAudioBrowserSDK/1.54.3/BanubaAudioBrowserSDK-1.54.3.xcframework.zip", :type => "zip" }
