Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaAudioBrowserSDK/1.54.2/BanubaAudioBrowserSDK-1.54.2.xcframework.zip", :type => "zip" }
