Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaARCloudSDK/1.53.2/BanubaARCloudSDK-1.53.2.xcframework.zip", :type => "zip" }
