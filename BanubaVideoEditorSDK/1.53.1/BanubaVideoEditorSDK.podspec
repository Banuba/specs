Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaVideoEditorSDK/1.53.1/BanubaVideoEditorSDK-1.53.1.xcframework.zip", :type => "zip" }
  ...
  s.dependency 'BanubaVideoEditorCore', '>= 1.53.1'
end
