Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaVideoEditorSDK/1.53.2/BanubaVideoEditorSDK-1.53.2.xcframework.zip", :type => "zip" }
  ...
  s.dependency 'BanubaLicenseServicingSDK', '>= 1.53.2'
  s.dependency 'BanubaUtilities', '>= 1.53.2'
