Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaVideoEditorSDK/1.54.2/BanubaVideoEditorSDK-1.54.2.xcframework.zip", :type => "zip" }
