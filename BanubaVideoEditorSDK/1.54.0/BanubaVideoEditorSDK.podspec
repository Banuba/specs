Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaVideoEditorSDK/1.54.0/BanubaVideoEditorSDK-1.54.0.xcframework.zip", :type => "zip" }
  ...
  s.dependency 'BanubaLicenseServicingSDK', '>= 1.54.0'
  s.dependency 'BanubaUtilities', '>= 1.54.0'
  s.dependency 'BanubaVideoEditorCore', '>= 1.54.0'
end
