Pod::Spec.new do |s|
  ...
  s.version          = "0.0.11-xcode.12.2-beta.0"
  s.summary          = "BanubaVideoEditorSDK"
  s.homepage         = "https://github.com/Banuba/BanubaVideoEditorSDK-iOS"
  s.license          = 'MIT'
  s.author           = { "Nickolai" => "nn@banuba.com" }
  s.source           = { :git => "git@github.com:Banuba/BanubaVideoEditorSDK-iOS.git", :tag => s.version }
  ...
  s.vendored_frameworks = 'BanubaVideoEditorSDK.framework'
