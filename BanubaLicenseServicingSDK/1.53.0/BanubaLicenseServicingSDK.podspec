Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaLicenseServicingSDK/1.53.0/BanubaLicenseServicingSDK-1.53.0.xcframework.zip", :type => "zip" }
