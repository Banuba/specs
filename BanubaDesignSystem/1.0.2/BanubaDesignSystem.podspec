Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaDesignSystem/1.0.2/BanubaDesignSystem-1.0.2.xcframework.zip", :type => "zip" }
