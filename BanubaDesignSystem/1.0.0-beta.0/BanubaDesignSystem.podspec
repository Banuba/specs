Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaDesignSystem/1.0.0-beta.0/BanubaDesignSystem-1.0.0-beta.0.xcframework.zip", :type => "zip" }
