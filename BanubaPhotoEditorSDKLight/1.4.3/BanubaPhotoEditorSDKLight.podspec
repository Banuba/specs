Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaPhotoEditorSDKLight/1.4.3/BanubaPhotoEditorSDKLight-1.4.3.xcframework.zip", :type => "zip" }
