Pod::Spec.new do |s|
  ...
  s.version          = "1.4.1-beta.0"
  s.summary          = "The Lightweight version of BanubaPhotoEditorSDK"
  s.homepage         = "https://github.com/Banuba/"
  s.license          = { :type => 'Commercial', :text => 'https://www.banuba.com/terms' }
  s.author           = { 'Banuba Limited' => 'info@banuba.com' }
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaPhotoEditorSDKLight/1.4.1-beta.0/BanubaPhotoEditorSDKLight-1.4.1-beta.0.xcframework.zip", :type => "zip" }
  ...
  s.dependency 'BanubaDesignSystem', '>= 1.0.3'
  s.dependency 'BanubaUtilities', '>= 1.53.1'
  s.dependency 'BanubaLicenseServicingSDK', '>= 1.53.1'
end
