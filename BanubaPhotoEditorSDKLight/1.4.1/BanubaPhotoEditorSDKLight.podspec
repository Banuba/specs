Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://nexus.banuba.net/repository/ios-frameworks/ios/frameworks/BanubaPhotoEditorSDKLight/1.4.1/BanubaPhotoEditorSDKLight-1.4.1.xcframework.zip", :type => "zip" }
